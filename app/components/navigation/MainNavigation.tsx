    ...
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-md border-t border-primary-100 md:hidden z-50">
        <div className="flex justify-around items-center h-16">
          ...
          <Link href="/worlds" className="flex flex-col items-center justify-center w-16 h-16 text-neutral-600 hover:text-primary-500">
            <span className="text-2xl">🌍</span>
          ...
          <Link href="/tasks" className="flex flex-col items-center justify-center w-16 h-16 text-neutral-600 hover:text-primary-500">
            <span className="text-2xl">📋</span>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 justify-between items-center">
            ...
            <div className="flex items-center space-x-8 rtl:space-x-reverse">
              ...
              <Link href="/worlds" className="text-neutral-600 hover:text-primary-500 transition-colors inline-flex items-center gap-2">
                <span>🌍</span>
                <span>עולמות</span>
              </Link>
              <Link href="/tasks" className="text-neutral-600 hover:text-primary-500 transition-colors inline-flex items-center gap-2">
                <span>📋</span>
                <span>משימות</span>
              </Link>
